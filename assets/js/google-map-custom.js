...
//*********************Google MAP *********************/
		...
		var saturation = 100 // 
		var mapLatitude=19.408525 
		var mapLongitude=-99.1144521//(Fist Value Latitude, Second Value ), get YOUR coordenates here!: http://itouchmap.com/latlong.html
		var mapZoom_value=17 // Map zoom level parameter only numeric  


// Google map marker example 2 locations 
		//map-marker #1
		var marker1_Latitude=19.408525 
		var marker1_Longitude=-99.1144521
		var marker1_content="Ubicación" // marker or  on click content (Info Window) 
